...
declare global {
  declare namespace App.Modules.Form {
    ...
    interface IFormContextData {
      ...
      errors: App.Modules.Form.FormErrors
      scopePath: string
      registerField: <TValue>(field: App.Modules.Form.FormField<TValue>) => void
    ...
    type FormProviderProps = {
      ...
      onSubmit: App.Modules.Form.FormOnSubmitFn
    }
  }
}
