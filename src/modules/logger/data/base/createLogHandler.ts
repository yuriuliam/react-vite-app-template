...
const createLoggerHandler = (
  appOutput: App.Modules.Logger.AppOutput,
  formatTime: Formatter<number | Date | undefined>,
  eventHandler?:
    | App.Modules.Event.EventHandler<App.Modules.Logger.LogEvent>
    | null
    | undefined,
): App.Modules.Logger.LogHandler => {
  return async (options: App.Modules.Logger.InternalMessageOptions) => {
